...
pub struct NotificationService {
    ...
    subscriber_repo: Arc<dyn NewCampaignSubscriptionRepository>,
...
impl NotificationService {
    ...
    pub async fn get_all_notifications(&self) -> Result<Vec<Notification>, AppError> {
        self.notification_repo.get_all_notifications().await
    }

    pub async fn get_notification_by_id(&self, notification_id: i32) -> Result<Option<Notification>, AppError> {
